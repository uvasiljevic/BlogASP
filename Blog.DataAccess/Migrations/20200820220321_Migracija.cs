    ...
    public partial class Migracija : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticlesImages_Images_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticlesRates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArticlesRates_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ArticlesRates_Rates_RateId",
                        column: x => x.RateId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticlesImages_ImageId",
                table: "ArticlesImages",
                column: "ImageId");

            migrationBuilder.CreateIndex(
                name: "IX_ArticlesRates_ArticleId",
                table: "ArticlesRates",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_ArticlesRates_RateId",
                table: "ArticlesRates",
                column: "RateId");
